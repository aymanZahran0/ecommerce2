...
//         <TextField onChange={getUserData} fullWidth placeholder='username' variant="standard" type='text' name='username' sx={{display:'block', my:'20px'}}/>
    ...
    <Grid container spacing={2}>
      ...
      >
        ...
        <TextField onChange={getUserData} fullWidth placeholder='username' variant="standard" type='text' name='username' sx={{display:'block', my:'20px'}}/>
          <TextField onChange={getUserData} fullWidth placeholder='Password' type='password' name='password' variant="standard" />
          {errorMessage?.length >0 ?<Typography variant="body1" color="error" sx={{display:'block'}}>{errorMessage}</Typography>:''}
          {error ?<Typography variant="body1" color="error" sx={{display:'block'}}>username or password is incorrect</Typography>:''}
          {errorValidate.map((err, index)=> <Typography key= {index} color='error'>{ err.message } </Typography>)}
